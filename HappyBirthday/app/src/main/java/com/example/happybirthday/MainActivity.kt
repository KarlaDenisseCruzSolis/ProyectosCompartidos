package com.example.happybirthday //Primer comentario
        ...
        setContent {
            HappyBirthdayTheme {
                Surface(
                    ...
                    GreetingText(
                        message = "Happy Birthday Yahir!", //Comentario de felicitación que cambié******
                        from = "From Karla",
...
fun GreetingText(message: String, from: String, modifier: Modifier = Modifier) {
    Box(modifier = modifier.fillMaxSize()) { // Se usa Box para superponer la imagen y el texto
        Image( // Se agrega la imagen de fondo
            painter = painterResource(R.drawable.androidparty2), // Se carga la imagen que modifiqé ********
